...
use App\ParseClasses\Product;
use App\ParseClasses\Photo;
...
class HomeController extends Controller
{
    ...
    public function demo()
    {
        ...
        $query = new ParseQuery($product->getClassName());
        $object = $query->first();

        try {
            $gameScore->save();
            echo 'New object created with objectId: ' . $gameScore->getObjectId() . '<br>';
        ...
        if ($currentUser) {
            ...
            echo '<br>Da dang nhap<br>';
        } else {
            // show the signup or login page
            echo '<br>Chua dang nhap<br>';
        }
    ...
    public function index()
    {
        ...
        $queryPhoto = new ParseQuery(Photo::$parseClassName);
        $photos = $queryPhoto->find();
        ...
        $sanpham = DB::table('sanpham')
            ...
            ->paginate(12);
//         print_r($object);
        return view ('frontend.pages.home',compact('loaisp','sanpham','products', 'photos'));
    }
