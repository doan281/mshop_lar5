...
return [
    ...
    */
    ...
    'server_url' => env('PARSE_SERVER_URL', 'http://104.168.102.145:1337'),
    'mount_path' => env('PARSE_SERVER_URL', 'parse'),
    'app_id'     => env('PARSE_APP_ID', 'mapsell'),
    'rest_key'   => env('PARSE_REST_KEY', 'restAPIKey'),
    'master_key' => env('PARSE_MASTER_KEY', 'pangachiu'),
